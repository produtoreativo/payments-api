...
<!-- Localização em exploração: prodops/artifacts/obcs/global/<slug>.md (Draft) -->
...
Draft. Localizado em `prodops/artifacts/obcs/global/<slug>.md`.
...
|---|---|---|---|
| <nome-do-repositório> | `prodops/artifacts/obcs/local/<slug>.md` | Draft | <data> |
