...
Downstream. Status `Entrou` em `prodops/artifacts/governance/plans/iteration-plan.md` (seção "Iteration Plan recomendado").
...
- OBCs relacionados: `prodops/artifacts/business/obcs/create-invoice.md`, `prodops/artifacts/business/obcs/webhook-configuration.md`
