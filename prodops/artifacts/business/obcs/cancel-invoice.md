...
Committed. Adiado para próxima iteração — ver `prodops/artifacts/governance/plans/iteration-plan.md` (decisão "Adiada"). OBC committed; disponível para Bootstrap + Hack na iteração seguinte.
...
- Iteration Plan: `prodops/artifacts/governance/plans/iteration-plan.md` (decisão: Adiada)
- Icebox: `prodops/artifacts/product/backlogs/icebox-backlog.md` — PAY-ICE-003
- OBCs relacionados: `prodops/artifacts/business/obcs/create-invoice.md`, `prodops/artifacts/business/obcs/payment-confirmation.md`
