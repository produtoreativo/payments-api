...
```text
prodops/artifacts/experiments/008-dora-extended-documentation/experiment.en.md
```
...
**File:** `prodops/artifacts/experiments/008-dora-extended-documentation/evidence/obc-dora-mapping.en.md`
...
- This experiment (created): `prodops/artifacts/experiments/008-dora-extended-documentation/`
