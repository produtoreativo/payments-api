...
```text
prodops/artifacts/experiments/008-dora-extended-documentation/experiment.md
```
...
**Arquivo:** `prodops/artifacts/experiments/008-dora-extended-documentation/evidence/obc-dora-mapping.md`
...
- Este experimento (criado): `prodops/artifacts/experiments/008-dora-extended-documentation/`
