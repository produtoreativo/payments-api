# Runbooks — Payments API

Procedimentos operacionais para suporte às releases da Payments API.

Os cenários cobertos foram identificados no pré-mortem da release:
[`prodops/artifacts/plans/reliability/premortem.md`](../plans/reliability/premortem.md)
...
**Registrar:** data/hora, escopo de pedidos afetados, decisão tomada → `prodops/artifacts/trails/operational-trail.md`
...
**Registrar:** → `prodops/artifacts/trails/operational-trail.md`
