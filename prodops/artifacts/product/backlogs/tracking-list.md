...
| Analisar e corrigir vulnerabilidades de segurança sinalizadas pelo Dependabot nas dependências do serviço. | GitHub Dependabot Security Alerts / Operation | Segurança/Dependências/Compliance | Tech Lead Payments | #55 | Parcialmente resolvido — 83/84 alertas fechados via DS-44 (PR #116, v0.7.0). 1 alerta high restante: `postcss` (Dependabot #101). | Rastrear em #118 — fix via `overrides` em `package.json`. |
| `postcss` dependência transitiva com Path Traversal via sourceMappingURL — não resolvida pela entrega DS-44. | Dependabot alert #101 — follow-up de DS-44 | Segurança/Dependências | Tech Lead Payments | #118 | Aberto | Identificar dependência direta que arrasta `postcss < 8.5.18` e aplicar `overrides` ou upgrade. |
