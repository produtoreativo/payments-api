...
BDD Features comprometidas — promovidas do modo Upstream para Downstream.

## Features disponíveis

| Feature | Descrição |
|---|---|
| [api-token-validation.feature](api-token-validation.feature) | Validação de token de API |
