...
Downstream. Status `Entrou` em `prodops/artifacts/plans/iteration-plan.md` — capacidade operacional derivada do EXP-010.
...
- BDD: `prodops/artifacts/bdd/observability-datadog.feature`
