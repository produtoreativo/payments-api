...
Downstream. Status `Entrou` in `prodops/artifacts/plans/iteration-plan.md` — operational capability derived from EXP-010.
...
- Related OBCs: `prodops/artifacts/obcs/production-cicd-pipeline.md`
