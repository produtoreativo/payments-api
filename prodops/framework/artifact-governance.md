...
| **OBC** | Implemented (durante Delivery) |
| **Critério de entrada** | OBC committed + BDD Feature committed + *(Reliability Plan — recomendado, obrigatório quando houver risco operacional relevante)* |
