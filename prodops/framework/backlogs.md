...
**Após a entrada, a origem deixa de importar.** O item evolui de estado no PIB: Draft → Refining (Icebox) → Committed (Iteration Backlog) → In Delivery (Iteration Plan) → Operational.
