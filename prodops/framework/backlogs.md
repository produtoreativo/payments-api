...
O OBC acompanha o trabalho por toda a sua vida — do momento em que a Intent é aceita até a operação em produção. Cada transição de backlog acima representa também uma transição de estado do OBC.
