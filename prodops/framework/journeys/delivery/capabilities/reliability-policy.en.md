...
After deploy, validate the reliability criteria defined in the OBC. Record evidence in the active session trail at `prodops/artifacts/governance/trails/sessions/YYYY-MM-DD-<session-id>.md` and in `prodops/framework/journeys/operation/operational-trail.md`.
