...
**Record:** date/time, scope of affected orders, decision made → [`prodops/framework/journeys/operation/operational-trail.md`](operational-trail.md)
...
**Record:** → [`prodops/framework/journeys/operation/operational-trail.md`](operational-trail.md)
