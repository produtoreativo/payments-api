...
**Registrar:** data/hora, escopo de pedidos afetados, decisão tomada → [`prodops/framework/journeys/operation/operational-trail.md`](operational-trail.md)
...
**Registrar:** → [`prodops/framework/journeys/operation/operational-trail.md`](operational-trail.md)
