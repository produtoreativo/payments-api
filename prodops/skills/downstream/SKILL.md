...
4. Reliability Plan produced by the parallel Assessment journey.
5. Item committed in the Iteration Plan with status `Entrou`.

Reliability precedes the Iteration Plan readiness decision. If any prerequisite is missing, stop before execution, identify the owning journey or artifact, and state the next action. Re-run readiness after the gap is resolved.
