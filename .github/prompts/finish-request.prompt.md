...
Execute apenas o step `request`. Importe o contexto de `AGENTS.md` e `prodops/framework/journeys/delivery/phases/finish/README.md` quando houver dúvida sobre fronteira.
